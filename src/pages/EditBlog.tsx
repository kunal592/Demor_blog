/**
 * Edit blog page component with markdown editor and form validation
 * Features: Pre-populated form, markdown editor, live preview, and update functionality
 */
...
const EditBlog: React.FC = () => {
  ...
  const handleSubmit = async (published: boolean) => {
    ...
    try {
      ...
      const blogData: Partial<BlogFormData> = {
        ...formData,
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Update your blog content and settings. Changes will be saved when you publish or save as draft.
          </p>
        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 min-h-96">
                ...
                <div className={`${showPreview ? 'hidden lg:block' : ''}`}>
                  <textarea
                    ...
                    placeholder="Update your blog content here... You can use markdown syntax for formatting."
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <p className="text-xs text-gray-500 mt-3 text-center">
                Changes will be saved when you update the blog
              </p>
            </div>
          </div>
        </div>
